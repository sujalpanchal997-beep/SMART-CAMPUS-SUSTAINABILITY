...
void handleRoot()
{
  ...
  html += "<style>";
  html += "body{margin:0;font-family:Poppins,Segoe UI;background:linear-gradient(135deg,#0f2027,#203a43,#2c5364);color:white;text-align:center}";
  ...
  html += "background:rgba(255,255,255,0.08);backdrop-filter:blur(10px);";
  ...
  html += "background:rgba(255,255,255,0.1);box-shadow:0 8px 20px rgba(0,0,0,0.3)}";
