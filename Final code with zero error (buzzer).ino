...
float warningLimit = 0.007;   // supports small values
...
void handleRoot()
{
  ...
  html += "<input type='number' step='0.001' name='warn' value='" + String(warningLimit,3) + "'><br>";
  html += "<div>Cut Limit (kWh)</div>";
  html += "<input type='number' step='0.001' name='cut' value='" + String(cutLimit,3) + "'><br>";
